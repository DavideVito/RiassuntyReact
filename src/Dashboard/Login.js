...
function Login(props) {
  ...
  let [token, cambiaToken] = useState("");
  ...
  function responseGoogle(risposta) {
    ...
    console.log(risposta.getAuthResponse());
    cambiaToken(risposta.getAuthResponse());
    sessionStorage.setItem("token", risposta.getAuthResponse().id_token);
